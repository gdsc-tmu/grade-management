      ...
      <div className="w-80 mx-auto">
        ...
        <div className="flex items-center">
          <div className="relative mt-1 rounded-md shadow-sm">
            <input type="text" name="code" id="code" className="block w-full rounded-md border-gray-300 pl-7 pr-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="A0000"/>
          ...
          <button onClick={handleClick} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 ml-2 rounded-lg">決定</button>
        </div>
      </div>
